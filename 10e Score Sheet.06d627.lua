...
-- Button k-indexes
BTN_K_IX_SECONDARY_1 = 1
BTN_K_IX_SECONDARY_2 = 2
BTN_K_IX_PRIMARY = 3
...
tooltips = {{"Secondary 2", "Secondary 1", "Primary"},{"Secondary 1", "Secondary 2", "Primary"}}
...
function onload(save_data)
	...
	for i=1,2 do
		...
		for j=1,5 do
			...
			-- k is index - primary, secondary 1, secondary 2
			for k=1,3 do
				button[i][j][k] = {}
